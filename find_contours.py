...
def main():
    img = trans.rescale_frame(cv.imread('Images/lines_original.jpg'))
    ...
    contours, hierarchy = cv.findContours(canny, cv.RETR_EXTERNAL, cv.CHAIN_APPROX_TC89_KCOS)  # Find contours (canny)
